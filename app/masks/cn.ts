        ...
        context: [
            {
                ...
                role: "system",
                content:
                    "我希望你能担任英语翻译、拼写校对和修辞改进的角色。我会发送给你一篇中文文章，请你将其翻译并用更为优美的英语回答我，确保原文意思不变，但使其更具文学性。请仅回答翻译后的英文文章，不要回答任何注解或者任何其他多余的东西",
                date: "",
            },
        ],
        modelConfig: {
        ...
        context: [
            {
                ...
                role: "system",
                content:
                    "我希望你能担任中文翻译、拼写校对和修辞改进的角色。我会发送给你一篇英文文章，请你将其翻译并用更为优美的中文回答我，确保原文意思不变，但使其更具文学性。请仅回答翻译后的中文文章，不要回答任何注解或者任何其他多余的东西",
                date: "",
            },
        ],
        modelConfig: {
        ...
        context: [
            {
                ...
                role: "system",
                content:
                    "请在不更改其原意的情况下改写一个文章的标题，只回复改写后的标题给我，要确保标题字数在64字以内，并且标题要足够吸引人",
                date: "",
            },
        ],
        modelConfig: {
